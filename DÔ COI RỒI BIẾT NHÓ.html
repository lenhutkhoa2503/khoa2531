   ...
   <div class="modal fade" id="myLove" role="dialog" style="display: none">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          ...
          <p class="love-you-know"> TUI BIẾT NGAY MÀ :D<span class="heart"></span></p>
       		<p class="love-you-know1"> TUI BIẾT NGAY MÀ. </p>
      </div>
  </div>
...
<div class="love-wrap">
    ...
    <h1> <b>ALO!!TUI THÍCH BÀ NHƯNG MÀ HỎNG DÁM NÓI, BÀ CÓ THÍCH TUI HONG?</b></h1>
    <div class="love-content">
        <button class="love-btn love-btn-one btn btn-default" data-status="6">KHÔNG</button>
        <button class="love-btn love-btn-two btn btn-default" data-status="5" style="top: 80px;">TUI CÓ</button>
    </div>
</div>
